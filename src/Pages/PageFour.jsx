  ...
  return (
    ...
    <div className='pageFourContainer'>
      ...
      <div className='tennisContainerPageFour'>
        <img className='imageTennisPageFour' style = {{height: "40vh"}} src ='src/assets/Images/PageFour_TennisBall.png'/>
      ...
      <div className='binocularContainerPageFour' id = 'binoculars'>
        <img className='imagePageFour' style = {{height: "40vh"}} src ='src/assets/Images/PageFour_Binoculars.png'/>
      ...
      <div className='potteryContainerPageFour' id = 'tasse'>
        <img className='imageOnePageFour' style = {{height: "40vh"}} src ='src/assets/Images/PageFour_Tasse.png'/>
      ...
      <div className='homecafeContainerPageFour' id = 'matcha'>
        <img className='imageTwoPageFour' style = {{height: "100vh"}} src ='src/assets/Images/PageFour_Matcha.png'/>
